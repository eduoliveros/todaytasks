...
export function TodayTasksViews(ctx){
  ...
  return {
    ...
    triageUndo:                   triageV.triageUndo,
    triageRedo:                   triageV.triageRedo,
    canTriageUndo:                triageV.canTriageUndo,
    canTriageRedo:                triageV.canTriageRedo,
    submitTriageNewTask:          triageV.submitTriageNewTask,
    openTriageNewTaskModal:       triageV.openTriageNewTaskModal,
    toggleTriageEditRecurring:    triageV.toggleTriageEditRecurring,
    onTriageRecurrenceFreqChange: triageV.onTriageRecurrenceFreqChange,
    toggleTriageRecurrenceDay:    triageV.toggleTriageRecurrenceDay,
    clearTriageRecurrenceEndDate: triageV.clearTriageRecurrenceEndDate,
    openMobileAddModal:           triageV.openMobileAddModal,
    closeMobileAddModal:          triageV.closeMobileAddModal,
    handleTriageAddBarSubmit:     triageV.handleTriageAddBarSubmit,
    handleMobileAddModalSubmit:   triageV.handleMobileAddModalSubmit,
    focusTriageAddBar:            triageV.focusTriageAddBar,
    moveTriageTaskDirection:      triageV.moveTriageTaskDirection,
    executeTriageBatchMoveDirection: triageV.executeTriageBatchMoveDirection,
    openMobileMoveSheet:          triageV.openMobileMoveSheet,
    closeMobileMoveSheet:         triageV.closeMobileMoveSheet,
    getActiveMoveSheetTaskId:     triageV.getActiveMoveSheetTaskId,
    handleTriageTouchStart:       triageV.handleTriageTouchStart,
