...
function switchHeaderTab(target){
  ...
  export const app = {
    ...
    startNewTask: actionsModule.startNewTask,
    ...
    moveTaskDirectly: actionsModule.moveTaskDirectly,
    moveTasksGroupDirectly: actionsModule.moveTasksGroupDirectly,
    reorderTaskByDrag: actionsModule.reorderTaskByDrag,
    checkIsDropTargetAllowed: actionsModule.checkIsDropTargetAllowed,
    toggleHistorySeries,
    ...
    triageUndo: () => viewsModule && viewsModule.triageUndo && viewsModule.triageUndo(),
    triageRedo: () => viewsModule && viewsModule.triageRedo && viewsModule.triageRedo(),
    canTriageUndo: () => viewsModule && viewsModule.canTriageUndo && viewsModule.canTriageUndo(),
    canTriageRedo: () => viewsModule && viewsModule.canTriageRedo && viewsModule.canTriageRedo(),
    openTriageNewTaskModal: (defaults) => viewsModule && viewsModule.openTriageNewTaskModal && viewsModule.openTriageNewTaskModal(defaults),
    toggleTriageEditRecurring: (checked) => viewsModule && viewsModule.toggleTriageEditRecurring && viewsModule.toggleTriageEditRecurring(checked),
    onTriageRecurrenceFreqChange: (freq) => viewsModule && viewsModule.onTriageRecurrenceFreqChange && viewsModule.onTriageRecurrenceFreqChange(freq),
    toggleTriageRecurrenceDay: (dayNum) => viewsModule && viewsModule.toggleTriageRecurrenceDay && viewsModule.toggleTriageRecurrenceDay(dayNum),
    clearTriageRecurrenceEndDate: () => viewsModule && viewsModule.clearTriageRecurrenceEndDate && viewsModule.clearTriageRecurrenceEndDate(),
    submitTriageNewTask: (title, dur, urg, feat, sa, notes, autoMove) => viewsModule && viewsModule.submitTriageNewTask && viewsModule.submitTriageNewTask(title, dur, urg, feat, sa, notes, autoMove),
    openMobileAddModal: () => viewsModule && viewsModule.openMobileAddModal && viewsModule.openMobileAddModal(),
    closeMobileAddModal: () => viewsModule && viewsModule.closeMobileAddModal && viewsModule.closeMobileAddModal(),
    handleTriageAddBarSubmit: (form) => viewsModule && viewsModule.handleTriageAddBarSubmit && viewsModule.handleTriageAddBarSubmit(form),
    handleMobileAddModalSubmit: (form) => viewsModule && viewsModule.handleMobileAddModalSubmit && viewsModule.handleMobileAddModalSubmit(form),
    focusTriageAddBar: () => viewsModule && viewsModule.focusTriageAddBar && viewsModule.focusTriageAddBar(),
    moveTriageTaskDirection: (taskId, dir) => viewsModule && viewsModule.moveTriageTaskDirection && viewsModule.moveTriageTaskDirection(taskId, dir),
    executeTriageBatchMoveDirection: (dir) => viewsModule && viewsModule.executeTriageBatchMoveDirection && viewsModule.executeTriageBatchMoveDirection(dir),
    openMobileMoveSheet: (taskId, event) => viewsModule && viewsModule.openMobileMoveSheet && viewsModule.openMobileMoveSheet(taskId, event),
    closeMobileMoveSheet: () => viewsModule && viewsModule.closeMobileMoveSheet && viewsModule.closeMobileMoveSheet(),
    getActiveMoveSheetTaskId: () => viewsModule && viewsModule.getActiveMoveSheetTaskId && viewsModule.getActiveMoveSheetTaskId(),
    handleTriageTouchStart: (taskId, event) => viewsModule && viewsModule.handleTriageTouchStart && viewsModule.handleTriageTouchStart(taskId, event),
    ...
    handleTriageMouseDown: (taskId, event) => viewsModule && viewsModule.handleTriageMouseDown && viewsModule.handleTriageMouseDown(taskId, event),
    ...
    handleTaskMouseDown: (taskId, event) => viewsModule && viewsModule.handleTaskMouseDown && viewsModule.handleTaskMouseDown(taskId, event),
